...
import type { MiddleUserType, EndUserType, TopUserType } from "@/frontend/user";
...
declare global {
    ...
    var xmongo: import("mongodb").MongoClient;
    var xdb: import("mongodb").Db;
    var styles: any;
    var main: Function;
    var nodeenv: string;
    var devmode: boolean;
    ...
    type APISession = {
        ...
        cat: string,
        expid: ObjectId,
        body: Partial<{ [key in string]: any }>,
        origin: string,
        topuser: TopUserType,
