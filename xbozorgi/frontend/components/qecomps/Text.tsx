...
export default (props: {
    ...
    return <f-c class={z.qestyles.itemalign} style={{ fontSize: props.fontSize, margin: "2px 0" }}>
        {props.title ? <span style={{ width: props.nospace ? null : z.lang.textw, 
            marginBottom: props.titlemb != undefined ? props.titlemb : 0 }}>
            {props.title}</span> : null}
        {props.nospace ? <sp-3 /> : null}

        {props.image && typeof props.image == "string" ? <img style={{
            display: "inline-block", verticalAlign: "middle",
            marginLeft: z.lang.dir == "rtl" ? 3 : -1, marginRight: z.lang.dir == "rtl" ? -2 : 3,
        ...
        {copy ? <><sp-2 /><img className={z.qestyles.menubtn} style={{ width: 15, height: 15, cursor: "pointer" }} src={global.cdn("/files/copy.svg")} alt="copy"
            onClick={() => { Copy(copy); alerter(z.lang.copied) }} /></> : null}
        <sp-3 />{wlink}

        {props.help || props.onhelp ? <><sp-3 /><img src={global.cdn("/files/helpg.svg")} alt="help"
