import { useEffect, createRef, CSSProperties, useRef, useState } from 'react';
...
export default (props: {
  ...
  return <c-x style={{ width: "100%", flex: 1, marginTop: props.title ? 5 : 0, fontSize: 12, direction: props.direction as any, ...props.style }}>
    ...
    <div style={{ display: "flex", alignItems: "center", marginTop: props.title ? 3 : 0, flex: 1 }}>
      ...
      {props.deltxt ? <img className={z.qestyles.hover} src={global.cdn("/files/close.svg")} style={{
        width: 18, height: 18,
        position: "absolute",
        left: ((props.dir || z.lang.dir) == "rtl") ? 30 : null,
        right: ((props.dir || z.lang.dir) == "ltr") ? 30 : null
      }} onClick={(e) => {
        ref.current.value = ""
        props.on?.("");
        if (props.tight && props.tightkey) {
          props.tight[props.tightkey] = ""
        }
      }} /> : null}
      <textarea rows={1}
        ...
        onKeyDown={(e) => {
          if (e.code == "Enter" || e.code == "NumpadEnter" || e.key == "Enter") {
            beforentervalue = e.currentTarget.value
