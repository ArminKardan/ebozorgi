...
export default (props: {
  ...
  return <>
    ...
    <div className={z.qestyles.dialog}
      style={{ width: "92vw", maxWidth: props.maxWidth || 430, zIndex: props.wz || (props.z ? props.z + 1 : 251), ...(props.style ||  crossstyles.forms.style) }}>
      <div style={{
        display: "flex", height: 30, alignItems: "center",
        backgroundColor: props.titlebgcolor || crossstyles.forms.titlebgcolor,
